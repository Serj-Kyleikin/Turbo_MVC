                ...
                <div>
                    <? for($i=0; $i<$countPages; $i++): ?>
                        ...
                        <div>
                            ...
                            <textarea required type="text" name="<? echo $pages[$i]['name']; ?>_name"><? echo $pages[$i]['title']; ?></textarea>
                        </div>
                        <div>
                            <label>meta (description)</label>
                            <textarea required type="text" name="<? echo $pages[$i]['name']; ?>_description"><? echo $pages[$i]['description']; ?></textarea>
                        </div>
                        <div>
                            <label>h1</label>
                        ...
                        <? for($i=0; $i<$countVacancys; $i++): ?>
                            <div class="job special" data-job="<? echo $vacancys[$i]['id']; ?>">
                                ...
                                <div>
                                    ...
                                    <input required type="text" name="job_name" value="<? echo $vacancys[$i]['name']; ?>">
                                </div>
                                <div>
                                    <label>Описание</label>
                                    <textarea required type="text" name="job_text"><? echo $vacancys[$i]['text']; ?></textarea>
                                </div>
                                <div>
                                    <label>Зарплата</label>
                                    <input required type="text" name="job_salary" value="<? echo $vacancys[$i]['salary']; ?>">
                                </div>
                                <div>
                                    <label>График</label>
                                    <input required type="text" name="job_worktime" value="<? echo $vacancys[$i]['worktime']; ?>">
                                </div>
                                <hr>
                            </div>
                        <? endfor; ?>
